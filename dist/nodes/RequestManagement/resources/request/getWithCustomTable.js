...
exports.getWithCustomTableDescription = [
    ...
    {
        ...descriptions_1.requestCustomTableSelectorDescription,
        displayOptions: {
            show: {
                resource: ['request'],
                operation: ['getWithCustomTable'],
...
async function execute(index) {
    ...
    const response = await transport_1.requestManagementApiRequest.call(this, 'POST', '/request/custom.table', body);
    if (response.code === 1) {
